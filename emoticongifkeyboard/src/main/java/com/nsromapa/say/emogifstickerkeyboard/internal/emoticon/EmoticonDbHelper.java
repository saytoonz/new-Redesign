...
package com.nsromapa.say.emogifstickerkeyboard.internal.emoticon;
...
final class EmoticonDbHelper extends SQLiteAssetHelper {
     ...
     * @see com.nsromapa.say.emogifstickerkeyboard.emoticons.EmoticonProvider#hasEmoticonIcon(String)
     */
    @NonNull
